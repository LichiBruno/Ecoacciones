...
function Chapter2() {
  return (
    <div className="Chapters">
      ...
      />
      <h3 style={yellow}>Consumo</h3>
      <p>
        En este capítulo desarrollaremos un enfoque sobre nuestros hábitos de
        consumo como una oportunidad para hacer visible nuestro cotidiano,
        reflexionar sobre el impacto que tiene nuestro modo de vida y
        plantearnos algunos desafíos iniciales.
      </p>
      <p>
        Consideramos que las oportunidades que nos brindan las crisis son
        motores para desarrollar la innovación y activar los cambios que nos
        conducirán a un entorno más sostenible, saludable y equitativo.
      </p>
      <h3 style={yellow}>Nuestra sociedad de consumo</h3>
      <h4>¿Cuál es el costo ambiental?</h4>
      <p>
        Todas las personas, casi de manera inevitable, consumimos diversos
        productos para sostener nuestra vida diaria. Para ello, dependemos del
        ambiente que nos rodea y de los beneficios que nos brindan los recursos
        de la naturaleza.
      </p>
      <p>
        Cada objeto que utilizamos durante el día lleva un proceso de producción
        en el cual se usa materia prima y energía. A la par de esto, cada
        persona consume en algún momento del día electricidad o gas proveniente
        de recursos naturales, renovables y no renovables.
      </p>
      <p>
        Ahora, cuando este consumo se ejerce de manera excesiva o innecesaria lo
        llamamos consumismo y esto profundiza las emisiones de gases, debido al
        plástico y demás componentes que se encuentran en los diferentes
        productos, a la vez que contribuye de manera directa o indirecta a la
        generación de residuos
      </p>
      <p>
        Frente a este escenario, nuestras acciones pueden ayudar a preservar y
        cuidar los recursos y el ambiente. A la hora de consumir, debemos
        reflexionar sobre qué consumimos. Una buena guía al respecto son las 5R
        para la sostenibilidad
      </p>
      <h3 style={yellow}>Las "5R"</h3>
      <p>
        Las "5R" para la sostenibilidad hacen referencia a las acciones de:{" "}
        <span style={yellow}>reducir</span>,{" "}
        <span style={yellow}>rechazar</span>,{" "}
        <span style={yellow}>reutilizar</span>,{" "}
        <span style={yellow}>reparar</span> y{" "}
        <span style={yellow}>reciclar</span>. 
        ¿Qué implican?
      </p>
      <p><span style={yellow}><strong>REDUCIR:</strong></span> Disminuir el uso de objetos que se convertirán luego en residuos, comprar de manera consciente, teniendi en cuenta en qué se va a utilizar, eligiendo en lo posible productos sostenibles o duraderos. Usar adecuadamente los productos con el menor desperdicio y dejar a un lado aquellos que no son biodegradables o que demoran mucho tiempo en desintegrarse</p>
      <p><span style={yellow}><strong>RECHAZAR:</strong></span> Apunta a no aceptar productos que contienen sustancias que impactan negativamente en el ambiente. Implica rechazar aquellos productos descartables y plásticos de un solo uso, como los sorbetes, las cucharitas de helado o café</p>
      <p><span style={yellow}><strong>REUTILIZAR:</strong></span> Es la acción que permite volver a usar un determinado producto para darle una segunda vida útil, ya sea reparándolo para dar el mismo uso o modificándolo para dar un uso diferente. Al reutilizar las cosas evitamos la generación de basura.</p>
      ...
      <p>El Ministerio de Ambiente de la Nación define al residuo como "todo elemento, material, objeto o sustancia que, como consecuencia de los procesos de consumo y desarrollo de actividades humanas, es desechado o abandonado. Los residuos sólidos urbanos (RSU) son análogos a los denominados domiciliarios y pueden ser de origen residencial, urbano, comercial, asistencial, sanitario, industrial o institucional, con excepción de aquellos que se encuentren regulados por normas específicas."</p>
      ...
      <h3 style={yellow}>¿Cómo separar?</h3>
      <h4 style={yellow}>Residuos Secos/ Inorgánicos</h4>
      <ul>
          <li>Plásticos</li>
          <li>Papeles</li>
          <li>Cartones</li>
          <li>Trapos</li>
          <li>Telas</li>
          <li>Vidrios (aislados)</li>
          <li>Telgopor</li>
          <li>Latas</li>
      </ul>
      <h4 style={yellow}>Residuos Húmedos/ Orgánicos</h4>
      <ul style={paddingBottom}>
          ...
          <li>Café</li>
          <li>Yerba</li>
          <li>Saquitos de té</li>
          <li>Hojas y flores</li>
      </ul>
      <p>La importancia de separar y reciclar radica fundamentalmente en:</p>
      <ul>
          <li><strong>USAR MENOS MATERIAS PRIMAS:</strong> Si reciclamos vidrio, papel o plástico en muchos casos no hay necesidad de utilizar nuevos recursos naturales para fabricar productos.</li>
          <li><strong>AHORRAR ENERGÍA:</strong> Se utiliza menos energía necesaria para llevar a cabo los proceso de extracción, transporte y elaboración de las materias primas.</li>
      ...
      <p>Se cuentan por millones las toneladas que terminan en mares, ríos, bosques, afectando la vida silvestre y generando daños en la salud de la población mundial.</p>
      <p>Acá te presentamos algunas de las acciones que podemos hacer para contribuir a mejorar el contexto:</p>
      <ul>
        <li>Dejar de usar botellas o vasos de plástico. Si es necesario consumir bebidas embotelladas, elige aquellas que sean de vidrio y retornables.</li>
        <li>Dejar de usar sorbetes, cubiertos plásticos, platos descartables.</li>
        <li>Dejar de usar toallitas húmedas en los casos que podamos reemplazarlas.</li>
        <li>Dejar de pedir bolsas plásticas cuando quello que transportaremos ya se encuentra empaquetado, como por ejemplo cuando pedimos comida.</li>
        <li>Utilizar para hacer las compras eco-bolsas que puedan ser de tela, plástico reciclado o papel.</li>
        <li>Utilizar recipientes de vidrio o de metal para guardar y proteger la comida en vez de bolsas plásticas o films.</li>
        <li>Reutilizar frascos de vidrio para guardar alimentos.</li>
      </ul>
      <iframe width="100%" height="100%" src="https://www.youtube.com/embed/iJgBH2cTENQ" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
      <h3 style={yellow}>COMPRAR DE MANERA INTELIGENTE:</h3>
      <h4 style={yellow}>Ventas a granel, productos sin envases</h4>
      <p>Comprar a granel significa que llevamos a la tienda nuestros propios envases, ya sean bolsas, frascos o <em>tuppers</em>, y colocamos directamente allí los productos que deseamos comprar para no utilizar recipientes ni bolsas de plástico. Es una modalidad de adquirir los diversos productos que conlleva diversos beneficios, así como también modifica hábitos de consumo que poseemos en pos de la protección de nuestro ambiente:</p>
      <ul>
        <li>Reducimos el uso de plástico (envases y etiquetas) y con ello el precio de los productos adquiridos.</li>
        <li>Podemos comprar cantidades adecuadas a nuestro consumo.</li>
        <li>Podemos comprar productos locales, ya que es más sencillo adquirirlos de este modo.</li>
      </ul>
      <p>Existen almacenes y tiendas en donde podemos adquirir productos a granel, ya sea artículos de limpieza, como alimentos y otros.</p>
      <p>Los comercios que ofrecen estos servicios y posibilidades pueden realizar compras mayoristas para el expendio de los mismos. Además, la diversidad de productos puede alcanzar distintos rubros, desde alimentos a productos de limpieza o cosmética, entre otros.</p>
      <p>Así, se reduce la huella de carbono por parte de todas las personas que participan de estos circuitos. Se pueden acompañar estas acciones con beneficios y protecciones estatales, que permitan mayor beneficio a los comercios, como también premiar a las y los clientes que accedan (premios, descuentos, regalos).</p>
      <h3 style={yellow}>6 CONSEJOS ÚTILES</h3>
      <ol>
        <li>Siempre llevá bolsas de tela para guardar tus compras.</li>
        <li>Comprá productos frescos a granel. Evitá envasados.</li>
        <li>Comprá tan solo lo que necesites.</li>
        <li>Priorizá el consumo de productos locales y de temporada.</li>
        <li>Planeá tus comidas con anticipación. Así reducirás desperdicio.</li>
        <li>¿Y qué tal si iniciás la producción de tus propios alimentos? Nuestra guía "Cultivar en la ciudad" te puede ser de utilidad.</li>
      </ol>
      <div style={neonYellow}>
      <h3 style={textGlow}>DESAFÍO 15 días</h3>
      <p>Durante los próximos quince días te proponemos descubrir los comercios a granel que pueden encontrarse en tu barrio. Para conocer aquellos productos que puedan comprarse allí según tus hábitos de consumo.</p>
      <p>Podés empezar limpiando algunos envases vacíos, para luego hacer tus compras. Con ello también podrás ver los productos que consumís y las cantidades necesarias en tu vida cotidiana.</p>
      <p>También podés dejar en tu bolso, cartera o en un lugar cercano, una eco-bolsa (de tela por ejemplo) a la que recurras a la hora de ir a hacer las compras, de modo que no tengas que utilizar bolsas plásticas cada vez.</p>
      </div>
    </div>
  );
}
